        ...
        <div className="grid md:grid-cols-2 gap-16 items-start">
          <div>
            ...
            <div className="space-y-4 text-muted-foreground leading-relaxed">
              <p>Olá! Eu sou o Lucio Macedo, apaixonado por tecnologia e redes de computadores, programação web e cibersegurança. Trabalho Infraestrutura,  redes, Segurança da informação e Desenvolvimento web.</p>
              <p>
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-3">
              {skills.map(skill => <span key={skill} className="px-4 py-2 text-sm bg-secondary border border-border rounded-full text-muted-foreground hover:text-foreground hover:border-primary/50 transition-colors">
                  {skill}
                </span>)}
            </div>
            ...
            <div className="flex flex-wrap gap-3">
              {learning.map(item => <span key={item} className="px-4 py-2 text-sm bg-primary/10 border border-primary/30 rounded-full text-primary">
                  {item}
                </span>)}
            </div>
          </div>
